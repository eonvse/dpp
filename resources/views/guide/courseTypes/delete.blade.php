        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                        <form method="post" action="{{ route('courseTypes.delete.confirm') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <a href="{{ route('courseTypes.list') }}" class="border-solid border border-green-500 rounded bg-green-100 hover:bg-green-200 p-2">Отменить</a>
                        </form>
                </div>
            </div>
        </div>
