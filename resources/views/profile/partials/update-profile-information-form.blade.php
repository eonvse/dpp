<section>
    <header>
        <h2 class="text-lg font-medium text-gray-900">Учетные данные</h2>
        <p class="mt-1 text-sm text-gray-600">Редактирование своих учетных данных для работы на сайте.</p>
    </header>
